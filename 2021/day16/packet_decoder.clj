...
(assert (= 16 (part1 (decode-packet (bit-string "8A004A801A8002F478")))))
(assert (= 12 (part1 (decode-packet (bit-string "620080001611562C8802118E34")))))
(assert (= 23 (part1 (decode-packet (bit-string "C0015000016115A2E0802F182340")))))
(assert (= 31 (part1 (decode-packet (bit-string "A0016C880162017C3686B18A3D4780")))))
